...
/*public class ColorSelectorWidget extends AbstractWidget {
    ...
    public boolean mouseClicked(MouseButtonEvent event, boolean doubleClick) {
        ...
        if (hexField.mouseClicked(event, doubleClick)) {
            return true;
        }
...
/*public class ColorSelectorWidget extends ClickableWidget {
    ...
    public void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // Border
        context.drawStrokedRectangle(boxX, boxY, BOX_SIZE, BOX_SIZE, 0xFF000000);
        
        // Hover-Effekt
        if (isMouseOverBox(mouseX, mouseY)) {
            context.drawStrokedRectangle(boxX - 1, boxY - 1, BOX_SIZE + 2, BOX_SIZE + 2, 0xFFFFFFFF);
        }
    }
